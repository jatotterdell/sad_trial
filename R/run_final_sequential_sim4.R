...
saveRDS(scenarios_dt, file = "~/out_files/mental_health_sims/basic_sequential_scenarios_final4.rds")
saveRDS(dat_trial, file = "~/out_files/mental_health_sims/basic_sequential_sims_final4.rds")
saveRDS(dat_sum, file = "~/out_files/mental_health_sims/basic_sequential_summary_final4.rds")
